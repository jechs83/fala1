...
def restart():
    ...
    subprocess.Popen(["start", "C:\GIT\\fala\\falabella\\as.py", "100"] ,shell=True, executable="C:\WINDOWS\system32\cmd.exe")
    time.sleep(5)
    '''
    subprocess.Popen(["start", "C:\GIT\\fala\\falabella\\as.py", "200"] ,shell=True, executable="C:\WINDOWS\system32\cmd.exe")
    time.sleep(5)
    subprocess.Popen(["start", "C:\GIT\\fala\\falabella\\as.py", "300"] ,shell=True, executable="C:\WINDOWS\system32\cmd.exe")
    time.sleep(5)
    subprocess.Popen(["start", "C:\GIT\\fala\\falabella\\as.py", "400"] ,shell=True, executable="C:\WINDOWS\system32\cmd.exe")
    time.sleep(5)
    subprocess.Popen(["start", "C:\GIT\\fala\\ripley\\as.py", "100"] ,shell=True, executable="C:\WINDOWS\system32\cmd.exe")
    time.sleep(5)
    subprocess.Popen(["start", "C:\GIT\\fala\\ripley\\as.py", "111"] ,shell=True, executable="C:\WINDOWS\system32\cmd.exe")
    time.sleep(5)
    subprocess.Popen(["start", "C:\GIT\\fala\\ripley\\as.py", "112"] ,shell=True, executable="C:\WINDOWS\system32\cmd.exe")
    time.sleep(5)
    subprocess.Popen(["start", "C:\GIT\\fala\\ripley\\as.py", "113"] ,shell=True, executable="C:\WINDOWS\system32\cmd.exe")
    time.sleep(5)
    subprocess.Popen(["start", "C:\GIT\\fala\\ripley\\as.py", "114"] ,shell=True, executable="C:\WINDOWS\system32\cmd.exe")
    time.sleep(5)
    subprocess.Popen(["start", "C:\GIT\\fala\\ripley\\as.py", "115"] ,shell=True, executable="C:\WINDOWS\system32\cmd.exe")
    time.sleep(5)
    subprocess.Popen(["start", "C:\GIT\\fala\\ripley\\as.py", "116"] ,shell=True, executable="C:\WINDOWS\system32\cmd.exe")
    '''
