...
def start():
    ...
    subprocess.Popen([ "start", "cmd" , "/k",  "C:\Git\\fala1\\buscador\\telegram_product-sindsct.py"], shell=True, executable="C:\windows\system32\cmd.exe")
    ...
    subprocess.Popen([ "start", "cmd" , "/k", "C:\Git\\fala1\\buscador\\telegram_saga70-100.py"], shell=True, executable="C:\windows\system32\cmd.exe")

    subprocess.Popen([ "start", "cmd" , "/k", "C:\Git\\fala1\\buscador\\telegram_curacao60-70.py"], shell=True, executable="C:\windows\system32\cmd.exe")
    ...
    subprocess.Popen([ "start", "cmd" , "/k",  "C:\Git\\fala1\\buscador\\telegram_promart70-100.py"], shell=True, executable="C:\windows\system32\cmd.exe")
    ...
    subprocess.Popen([ "start", "cmd" , "/k",  "C:\Git\\fala1\\buscador\\telegram_plaza70-100.py"], shell=True, executable="C:\windows\system32\cmd.exe")
    subprocess.Popen([ "start", "cmd" , "/k",  "C:\Git\\fala1\\buscador\\telegram_plaza60-70.py"], shell=True, executable="C:\windows\system32\cmd.exe")


    subprocess.Popen([ "start", "cmd" , "/k",  "C:\Git\\fala1\\buscador\\telegram_tailoy70-100.py"], shell=True, executable="C:\windows\system32\cmd.exe")
    subprocess.Popen([ "start", "cmd" , "/k",  "C:\Git\\fala1\\buscador\\telegram_tailoy60-70.py"], shell=True, executable="C:\windows\system32\cmd.exe")
csubprocess.Popen([ "start", "cmd" , "/k",  "C:\Git\\fala1\\buscador\\telegram_cool70-100.py"], shell=True, executable="C:\windows\system32\cmd.exe")
