...
t1 =  collection5.find( {"web_dsct":{ "$gte":95},"date":date ,"brand":{"$in":[ 
...
def auto_telegram():
    ...
    a= collection_offer1.find({"sku":i["sku"],"list_price":i["list_price"], 
                            "best_price":i["best_price"], "card_price":i["card_price"],"web_dsct":i["web_dsct"]})
   
    # a_list=[]
    set_a = set()

    b= collection_offer2.find({"sku":i["sku"],"list_price":i["list_price"], 
                            "best_price":i["best_price"], "card_price":i["card_price"],"web_dsct":i["web_dsct"]})
    # b_list=[]
    set_b = set()
    ...
    # for i in a : a_list.append(i)
    # for i in b : b_list.append(i)
    ...
    # for i in new_list:
    #     #send_telegram( ("<b>Marca: "+i["brand"]+"</b>\nModelo: "+i["product"]+"\nPrecio Lista :" +str(i["list_price"])+ "\n<b>Precio web :"+str(i["best_price"])+"</b>\nPrecio Tarjeta :"+str(i["card_price"])+"\n"+i["image"]+"\nLink :"+str(i["link"])))
    #     print();print(i["sku"]);print(i["brand"]);print(i["product"]),print(i["link"]), print()
    #     save_data_to_mongo_db( i["sku"], i["brand"] , i["product"], i["list_price"], 
