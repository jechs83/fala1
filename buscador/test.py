...
class send_telegram_message():

    def __init__(self) -> None:
        pass


    def send_telegram(self,api_key,message):
        requests.post(api_key,data= {'chat_id': config("VOYAGER_CHAT_TOKEN"),'text': str(message) , 
            'parse_mode':ParseMode.HTML}  ) 
        
        
    
tele_message = send_telegram_message()
tele_message.send_telegram(config("VOYAGER_KEY"),"mensaje pi pi pi")
